...
-- MOVE TO CELL --
-- SAFARI HOENN ALL MAPS ------------------------------------------------------------------------------
DescMaps["Hoenn Safari Zone Lobby_to_Hoenn Safari Zone Area 1"] = {function() Mode_MoveToCell("Hoenn Safari Zone Lobby", 7,79,78,148,36,79) end}
...
DescMaps["Vermilion City_to_Lilycove City Harbor"] = {function() Mode_SpeakWithNPC("Vermilion City","Where do you want to go, mate?",{2},58,61,58,62) end}
