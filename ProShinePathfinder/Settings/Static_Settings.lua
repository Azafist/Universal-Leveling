...
--  Default Settings
    default        = {
        ...
        K_SUBWAY   = 1, -- Weight for using the subway path. Kanto
        J_SUBWAY   = 1, -- Weight for using the subway path. Johto
        H_SUBWAY   = 1, -- Weight for using the subway path. Hoenn

        J_TO_K     = 1, -- Weight of the Subway from Johto to Kanto and reverse.
        H_TO_KJ    = 1 -- Weight of the Subway from Hoenn to Kanto/Johto and reverse.
    },
